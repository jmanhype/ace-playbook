# MAGNITUDE Episode 3 — Channel 8 Interruption

**Status:** ten start/end frames ready  
**Runtime:** five 3-second shots; 15 seconds total  
**Picture:** horizontal 4:3, 1536×1152, 24 fps  
**Format:** May 17, 1979 local-TV weather broadcast recorded from a curved CRT
...
- Signal damage must remain analog: scanline warp, tracking tears, vertical hold, chroma phase error, tube bloom, ghosting, and dropout.
- Never introduce military-harbor imagery, modern graphics, phone footage, cinematic drone movement, trailer styling, or clean VFX.
