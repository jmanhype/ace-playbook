...
def upgrade() -> None:
    ...
    op.create_table(
        "diff_journal_entries",
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column(
            "task_id", sa.String(length=36), nullable=False, comment="Task that triggered update"
        ),
        sa.Column(
            "domain_id",
            sa.String(length=64),
            nullable=False,
            comment="Domain namespace for isolation",
        ),
        ...
        sa.Column(
            "before_hash", sa.String(length=64), nullable=True, comment="SHA-256 hash before update"
        ),
        sa.Column(
            "after_hash", sa.String(length=64), nullable=True, comment="SHA-256 hash after update"
        ),
        ...
        sa.Column(
            ...
            sa.String(length=32),
            nullable=True,
            comment="Shadow/Staging/Prod at time of change",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_diff_journal_entries")),
    )
    op.create_index(
        op.f("ix_diff_journal_entries_bullet_id"),
        "diff_journal_entries",
        ["bullet_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_diff_journal_entries_domain_id"),
        "diff_journal_entries",
        ["domain_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_diff_journal_entries_operation"),
        "diff_journal_entries",
        ["operation"],
        unique=False,
    )
    op.create_index(
        op.f("ix_diff_journal_entries_stage"), "diff_journal_entries", ["stage"], unique=False
    )
    op.create_index(
        op.f("ix_diff_journal_entries_task_id"), "diff_journal_entries", ["task_id"], unique=False
    )
    op.create_index(
        op.f("ix_diff_journal_entries_timestamp"),
        "diff_journal_entries",
        ["timestamp"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "stage",
            sa.Enum("SHADOW", "STAGING", "PROD", "QUARANTINED", name="playbookstage"),
            nullable=False,
    ...
    op.create_index(
        "idx_domain_section", "playbook_bullets", ["domain_id", "section"], unique=False
    )
    op.create_index("idx_domain_stage", "playbook_bullets", ["domain_id", "stage"], unique=False)
    op.create_index(
        op.f("ix_playbook_bullets_domain_id"), "playbook_bullets", ["domain_id"], unique=False
    )
    op.create_index(
        op.f("ix_playbook_bullets_section"), "playbook_bullets", ["section"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=64),
            nullable=False,
            comment="Multi-tenant namespace (CHK077-CHK078)",
        ),
        ...
        sa.Column(
            "ground_truth", sa.Text(), nullable=True, comment="Known correct answer (optional)"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "analysis_summary", sa.Text(), nullable=False, comment="High-level outcome summary"
        ),
        sa.Column(
            "confidence_score",
            sa.Float(),
            nullable=False,
            comment="Overall reflection quality (0.0-1.0)",
        ),
        sa.Column(
            "requires_human_review",
            sa.JSON(),
            nullable=False,
            comment="bool - high impact but low confidence",
        ),
        sa.Column(
            "feedback_types_used",
            sa.JSON(),
            nullable=False,
            comment="List[str] - feedback signals analyzed",
        ),
        sa.Column(
            "referenced_steps",
            sa.JSON(),
            nullable=False,
            comment="List[int] - reasoning trace indices analyzed",
        ),
        sa.Column(
            "contradicts_existing",
            sa.JSON(),
            nullable=False,
            comment="List[str] - conflicting bullet IDs",
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["task_id"], ["tasks.id"], name=op.f("fk_reflections_task_id_tasks")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.JSON(),
            nullable=False,
            comment="List[str] - step-by-step reasoning process",
        ),
        sa.Column("answer", sa.Text(), nullable=False, comment="Final answer from Generator"),
        sa.Column(
            "confidence", sa.Float(), nullable=False, comment="Generator confidence (0.0-1.0)"
        ),
        sa.Column(
            "bullets_referenced",
            sa.JSON(),
            nullable=False,
            comment="List[str] - playbook bullet IDs consulted",
        ),
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column(
            "test_results", sa.JSON(), nullable=True, comment="Dict[str, bool] - test pass/fail"
        ),
        sa.Column("error_messages", sa.JSON(), nullable=True, comment="List[str] - runtime errors"),
        sa.Column(
            "performance_metrics", sa.JSON(), nullable=True, comment="Dict[str, float] - metrics"
        ),
        sa.Column(
            "environment_feedback",
            sa.JSON(),
            nullable=True,
            comment="Dict - external system responses",
        ),
        sa.ForeignKeyConstraint(
            ["task_id"], ["tasks.id"], name=op.f("fk_task_outputs_task_id_tasks")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Float(),
            nullable=False,
            comment="Insight validity confidence (0.0-1.0)",
        ),
        sa.Column(
            "rationale",
            sa.Text(),
            nullable=False,
            comment="Explanation linking insight to feedback",
        ),
        sa.Column("tags", sa.JSON(), nullable=False, comment="List[str] - domain/category tags"),
        sa.Column(
            "referenced_steps",
            sa.JSON(),
            nullable=False,
            comment="List[int] - reasoning trace step indices",
        ),
        sa.Column(
            "embedding",
            sa.JSON(),
            nullable=True,
            comment="List[float] - 384-dim vector (computed by Curator)",
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["reflection_id"],
            ["reflections.id"],
            name=op.f("fk_insight_candidates_reflection_id_reflections"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_insight_candidates")),
    )
    op.create_index(
        op.f("ix_insight_candidates_reflection_id"),
        "insight_candidates",
        ["reflection_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_insight_candidates_section"), "insight_candidates", ["section"], unique=False
    )
